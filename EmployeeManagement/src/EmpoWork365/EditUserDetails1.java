 ...
 * @author jenal
 */
public final class EditUserDetails1 extends javax.swing.JFrame {
     ...
     * @param mainEmployee
     */
    public EditUserDetails1(MainAdmin mainAdmin, MainEmployee mainEmployee) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(query)) {
            ...
            if (rs.next()) {
                return firstName.getText().equals(rs.getString("fld_first_name"))
                    ...
                    && comboBoxGender.getSelectedItem().toString().equals(rs.getString("fld_gender"))
                    && (imageLocation == null ? rs.getString("fld_image_path") == null : imageLocation.equals(rs.getString("fld_image_path")));
            }
        } catch (SQLException e) {
    ...
    private boolean areFieldsEmpty() {
        boolean isEmpty = firstName.getText().trim().isEmpty() || 
                          lastName.getText().trim().isEmpty() || 
                          eMail.getText().trim().isEmpty() || 
                          String.valueOf(passWord.getPassword()).trim().isEmpty() ||
                          comboBoxGender.getSelectedItem() == null ||
                          imageLocation == null || 
                          imageLocation.equals("null") || // Check for the string "null"
                          imageLocation.trim().isEmpty();  // Ensure it's not just whitespace
    ...
    private void btnConfirmEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmEditActionPerformed
        ...
        if (isDataUnchanged(currentUserId)) {
    ...
    private void displayImage(String imagePath) {
        ...
        try {
            ...
            if (imageFile.exists()) {
                ...
                if (img != null) {
                    int width = 100; // Adjust dimensions as necessary
                    int height = 100;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditUserDetails1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new EditUserDetails1(mainAdmin, mainEmployee).setVisible(true);
            }
        });
    }
